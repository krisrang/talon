...
Paperclip::Attachment.default_options[:fog_directory] = ENV['GOOGLE_THUMBS_DIR']
...
if Rails.env.production?
  ...
  Paperclip::Attachment.default_options[:fog_host] = "http://localhost:3000/#{ENV['GOOGLE_THUMBS_DIR']}"
end
